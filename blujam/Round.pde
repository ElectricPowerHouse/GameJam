...
class Round{
  ...
  Player playerOne = new Player(0.0, ellipseSz/2.0, playerWd, playerHt, color(20,255,220));
  Player playerTwo = new Player(PI, ellipseSz/2.0, playerWd, playerHt, color(255,210,20));
