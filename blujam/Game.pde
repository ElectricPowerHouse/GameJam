...
class Game{
 ...
 SoundManager chargeMax;
  ...
  Game(){
    ...
    gameOver= false;
    roundNum = 1;
    round = new Round(roundNum, playerOneScore, playerTwoScore,shortShots,medShots,longShots,jumpSounds,deathSounds, bounceSounds, chargeUp, chargeMax, pickupSpawnSounds, 
    pickupGetSounds);
